...
// export const weAUDAddress = '0xd840c271D14fbEB9625Abc95383aEBd7eCc876ce';
// BNB Testnet 
const invoiceDelegateAddress = '0x39A43B393C98991633C114B8DE048da7E9400DEf';
const invoiceSvgAddress = '0xfc440Db7157562f048a7Db8ee6Db228b4109fa13';
const receivableDelegateAddress = '0x9723D5cc4098AaB073aD94935aFaFe017e739d98';
const receivableSvgAddress = '0x3Fa260f2FD01b6301918A9Fc50323d9DE7D4091e';
const weAUDAddress = '0x4051BF4dE0514d5B125eC11064E2dc178ef3e595';
...
function Topbar() {
    ...
    (0,react.useEffect)(()=>{
        if (isActive && account && (!chainId || chainId !== dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET)) {
            onOpenSwitchChainModel();
        }
        getWeAudBalance();
        const timerId = setInterval(()=>{
            if (isActive && account && chainId === dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET) {
                getWeAudBalance();
            }
        }, TIMER_INTERVAL);
    ...
    const onOpenSwitchChainModel = (0,react.useCallback)(()=>{
        switchChain(dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET);
    }, []);
    ...
    const showSearchBar = account && chainId === dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET && (pathname === '/pay' || pathname === '/trade' || pathname === '/get-paid' || pathname === '/my-issurance');
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    chainId === dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET ? /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                ...
                                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(menu/* Menu.Item */.v.Item, {
                                                    children: ({ active , close  })=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                                            children: [
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
                                                                                            href: (0,dist/* getExplorerLink */.E8)(chainId || dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET, account, dist/* ExplorerDataType.ADDRESS */.rl.ADDRESS),
                                                                                            target: "_blank",
                                                                                            children: shortenAddress(account)
                                                                                        }),
                                                                                ...
                                                                                chainId === dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET && !!weAudBalance && /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                                                                    className: "text-[#959A9F]",
                                                                                    children: [
                                                                                        "Balance: ",
                                                                                        /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                                ...
                                                                chainId !== dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET ? /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                                                                    ...
                                                                    children: "Switch to the BNB Testnet"
...
const WithTxConfirmation = (props)=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Modal, {
            ...
            className: (0,tw_merge/* twMerge */.m)('w-[25.7143rem]', className),
                ...
                children: successText && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(react_router_dom_dist/* Link */.rU, {
                            to: "/my-issurance",
                            className: (0,tw_merge/* twMerge */.m)('w-full gap-2 fill-white inline-flex items-center rounded-[7.1429rem] h-[3.7143rem] justify-center px-4 py-2 border border-solid border-[#7918F5] text-base font-medium text-white hover:bg-#7918F5', 'mt-[8px] text-[#7918F5]'),
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(components_Button, {
                            className: (0,tw_merge/* twMerge */.m)('bg-[#7918F5] rounded text-[#FBFAFC] text-[1rem] border-none font-semibold h-[4rem] w-[11.85714rem]', !isValidInvoiceForm && 'opacity-50 cursor-not-allowed'),
                            ...
                            /*#__PURE__*/ return (0,jsx_runtime.jsxs)(headlessui_float/* Float */.bv, {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(menu/* Menu.Button */.v.Button, {
                                        className: (0,tw_merge/* twMerge */.m)('bg-[#ECEDEE] rounded-full flex border-0 items-center justify-center h-[2.57143rem] w-[2.57143rem] p-2.5 cursor-pointer', 'hover:bg-[#7918F5] hover:text-white hover:fill-white', open && 'text-white bg-[#7918F5]'),
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(GetPaid_ItemButton, {
                            url: `https://testnets.opensea.io/assets/bsc-testnet/${receivableDelegateAddress}/${selectedReceivable == null ? void 0 : selectedReceivable.id}`,
...
const ViewBox_ViewBox = ({ invoice  })=>{
    const [isCopied, onCopy] = useCopyClipboard();
    const goto = ()=>{
        // window.open(`https://sepolia.etherscan.io/nft/${invoiceDelegateAddress}/${invoice?.id}`, '_blank');
...
function Dashboard() {
    ...
    const handleWalletConnect = (0,react.useCallback)(()=>{
        ...
        if (!chainId || chainId !== dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET) {
            switchChain(dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET);
            return false;
        }
        return true;
...
const client = (0,urql_core/* createClient */.eI)({
    url: "https://api.thegraph.com/subgraphs/name/solv-victor/ubt-chapel" || 0,
    exchanges: [
...
const App = ()=>{
    const { account , chainId , switchChain  } = (0,dist/* useWeb3Provider */.xo)();
    const [showWalletModal, setShowWalletModal] = (0,react.useState)(false);
    const routing = (0,react_router_dist/* useRoutes */.V$)(web_routes(!!account && !!chainId && chainId === dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET));
    ...
    (0,react.useEffect)(()=>{
        const timerId = setTimeout(()=>{
            if ((!account || chainId !== dist/* SupportedChainId.BSC_TESTNET */.HL.BSC_TESTNET) && pathname !== '/') {
                handleWalletConnect();
                navigate('/');
            }
        }, 1000);
...
/******/ __webpack_require__.O(0, [589,986,998], () => (__webpack_exec__(30738)));
